...
const Projects = () => {
  return (
    <div className="container mt-5">
      <div className="row">
        <div className="col">
          <a href={"https://h-app-harshverma.herokuapp.com/"} target="_blank" rel="noopener noreferrer">
            {" "}
        ...
        <div className="col">
          <a href={"https://www.canva.com/your-projects"} target="_blank" rel="noopener noreferrer">
