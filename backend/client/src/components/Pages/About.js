      ...
      <div className="icons">
        <ul>
          <li>
            <a
              className="facebook"
              href="https://www.facebook.com/harsh.verma.7140/" rel="noopener noreferrer"
              target="_blank"
          ...
          <li>
            <a
              className="instagram"
              href="https://www.instagram.com/harsh__vrm/" rel="noopener noreferrer"
              target="_blank"
          ...
          <li>
            <a
              className="linkedin"
              href="https://www.linkedin.com/in/harsh-verma-8aa66a1b3/" rel="noopener noreferrer"
              target="_blank"
